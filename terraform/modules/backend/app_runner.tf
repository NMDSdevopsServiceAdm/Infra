resource "aws_apprunner_service" "sfc_app_runner" {
  ...
  auto_scaling_configuration_arn = aws_apprunner_auto_scaling_configuration_version.sfc-app-runner-auto-scaling-config.arn   
...
resource "aws_apprunner_auto_scaling_configuration_version" "sfc-app-runner-auto-scaling-config" {                            
