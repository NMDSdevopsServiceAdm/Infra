...
data "aws_iam_policy_document" "codebuildservicerole_policy" {
  ...
  statement {
    ...
    resources = [
      ...
      aws_codebuild_project.codebuild_terraform_apply_build_and_deploy.arn,
      ...
      aws_codebuild_project.codebuild_asc_wds_build_frontend_preprod.arn,
      aws_codebuild_project.codebuild_asc_wds_build_frontend_prod.arn,
      aws_codebuild_project.codebuild_asc_wds_build_deploy_frontend_staging.arn,
      aws_codebuild_project.codebuild_asc_wds_build_deploy_frontend_preprod.arn,
      aws_codebuild_project.codebuild_asc_wds_build_deploy_frontend_prod.arn,
      ...
      aws_codebuild_project.codebuild_asc_wds_deploy_pre_prod.arn,
      aws_codebuild_project.codebuild_asc_wds_deploy_prod.arn,
      aws_codebuild_project.codebuild_asc_wds_deploy_benchmark.arn
      ]
  }
